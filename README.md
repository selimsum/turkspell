...
The original, noisy V1 and V2 official test sets suffered from **noisy gold data**, **spelling errors inside the test set keys**, and **Windows console encoding mismatches** that severely polluted spelling denetleyicisi accuracy metrics. 
