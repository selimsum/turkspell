...
def remap_aff_file(input_path: str = 'tr_v2.aff', output_path: str = 'tr_utf8.aff'):
...
def main():
    # 1. Compile baseline (writes tr.dic and tr_v2.aff)
    print("Step 1: Compiling baseline dictionary and rules...")
    compile_dictionary()

    # 2. Remap tr_v2.aff to tr_utf8.aff
    print("Step 2: Remapping affix rules to FLAG UTF-8...")
    remap_aff_file('tr_v2.aff', 'tr_utf8.aff')
