...
def compile_dictionary():
    ...
    if not os.path.exists(lexicon_path):
        lexicon_path = os.path.join('..', 'zemberek_lexicon.json')
    ...
    if not os.path.exists(oscar_path):
        oscar_path = os.path.join('..', 'oscar_parsed_candidates.json')
    ...
    for item in lexicon:
        ...
        if flag:
            ...
            # Map first-fold noun flags to include their basic second-fold counterparts
            flag_parts = flag.split(',')
            mapped_parts = []
            for fp in flag_parts:
                mapped_parts.append(fp)
                try:
                    val = int(fp)
                    if 1 <= val <= 8 or val == 18 or val == 19:
                        if val in [1, 7, 18]:
                            mapped_parts.append("81")
                        elif val in [2, 8, 19]:
                            mapped_parts.append("82")
                        elif val == 5:
                            mapped_parts.append("85")
                        elif val == 6:
                            mapped_parts.append("86")
                        elif val == 3:
                            mapped_parts.append("83")
                        elif val == 4:
                            mapped_parts.append("84")
                    elif 101 <= val <= 108 or val == 118 or val == 119:
                        if val in [101, 107, 118]:
                            mapped_parts.append("181")
                        elif val in [102, 108, 119]:
                            mapped_parts.append("182")
                        elif val == 105:
                            mapped_parts.append("185")
                        elif val == 106:
                            mapped_parts.append("186")
                        elif val == 103:
                            mapped_parts.append("183")
                        elif val == 104:
                            mapped_parts.append("184")
                except ValueError:
                    pass
            flag = ','.join(mapped_parts)
